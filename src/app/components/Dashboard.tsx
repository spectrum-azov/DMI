    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-yellow-50/50 border border-yellow-200 rounded-lg p-6 dark:bg-yellow-900/10 dark:border-yellow-800">
          ...
          <h3 className="font-medium text-yellow-900 dark:text-yellow-200">Потреби в обробці</h3>
          <p className="text-sm text-yellow-700 dark:text-yellow-300 mt-1">Очікують розгляду</p>
        </div>
