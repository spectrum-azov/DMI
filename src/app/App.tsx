...
import { TabType, DirectoryTab } from './types';
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col md:flex-row">
      <AppSidebar
        ...
        isDirectoriesOpen={isDirectoriesOpen}
        setIsDirectoriesOpen={setIsDirectoriesOpen}
        handleTabChange={handleTabChange}
        filteredNeedsCount={filteredNeedsCount}
        needsCount={needsData.length}
        filteredIssuanceCount={filteredIssuanceCount}
        issuanceCount={issuanceData.length}
        filteredRejectedCount={filteredRejectedCount}
